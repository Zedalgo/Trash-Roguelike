...
class GameMap:
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width, map_height, player, entities):
        ...
        for r in range(max_rooms):
            ...
            # random position in the boundaries
            ...
            for other_room in rooms:
                ...
                # if the spot's good, place the room
                self.create_room(new_room)

                # center coordinates of room
                ...
                if num_rooms == 0:
                    ...
                    # coin toss to determine behavior
                    if randint(0, 1) == 1:
    ...
    def create_room(self, room):
        # makes the entire rectangle passable
        ...
        for i in range(number_of_monsters):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if monster_choice == 'orc':
                    fighter_component = Fighter(max_hp=20, hp=20, defense=0, power=4, xp=35)
                    ai_component = BasicMonster()

                    monster = Entity(x, y, 'o', libtcod.desaturated_green, 'Orc', blocks=True,
                                     render_order=RenderOrder.ACTOR, fighter=fighter_component, ai=ai_component)
                else:
                    fighter_component = Fighter(max_hp=30, hp=30, defense=2, power=8, xp=100)
                    ai_component = BasicMonster()
